...
- Hold frame fidelity until the frame is locked in Round 00, then hold the locked frame throughout.
...
The files in `synthesis/` are professional consulting documents for the decision owner. They must read as client-grade deliverables, not as a record of this process.
...
- Cite evidence as findings a reader can verify (the source document, the market data), not as internal item IDs or round labels.
